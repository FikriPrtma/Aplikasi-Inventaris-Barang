...
@section('body')
    <form action="{{ url('barang-masuk/create') }}" method="POST">
        @csrf
        ...
        <div class="form-group input-group-sm mb-3">
            ...
            <select name="id_barang" class="w-100 select2 form-select @error('id_barang') is-invalid @enderror">
                <option value="">-- Nama barang masuk --</option>
                @foreach ($barang as $b)
        ...
        <div class="form-group input-group-sm mb-3">
            ...
            <input type="number" name="jumlah_masuk" class="form-control @error('jumlah_masuk') is-invalid @enderror" placeholder="Jumlah barang masuk (Bundel)" value="{{ old('jumlah_masuk') }}">
            @error('jumlah_masuk')
            <div class="invalid-feedback ms-2">
                {{ $message }}
            </div>
        ...
        <div class="row">
            <div class="text-end">
                ...
                <button class="btn btn-primary btn-sm rounded-0" type="submit">Tambah Barang Masuk</button>
            </div>
        </div>
